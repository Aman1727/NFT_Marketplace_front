...
const ConnectWallet = () => {
    ...
    const metaMask = async ()=>{
        ...
        axios.post(process.env.REACT_APP_BASEURL+"users/getprofile", { address: accountdetails.address })
          .then(res => {
            if (res.data.status) {
              dispatch(setProfile({
                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-md-6">
                                ...
                                <button onClick={!details.account?metaMask:()=>history.push("/")} className="btn btn-outline-primary btn-block btn-lg">
                                    <div className="flex">
